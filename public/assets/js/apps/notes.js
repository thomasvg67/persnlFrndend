...
var getNoteTitleInput = document.getElementById('n-title');
if (getNoteTitleInput) {
  getNoteTitleInput.addEventListener('input', function() {
    var getNoteTitleInputValue = this.value;
...
var getNoteDescriptionInput = document.getElementById('n-description');
if (getNoteDescriptionInput) {
  getNoteDescriptionInput.addEventListener('input', function() {
    var getNoteDescriptionInputValue = this.value;
