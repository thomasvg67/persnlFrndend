...
$('#addContactModal').on('hidden.bs.modal', function (e) {
    ...
    if ($_occupation) $_occupation.value = '';
    ...
    if ($_getValidationField.length) {
  for (let i = 0; i < $_getValidationField.length; i++) {
    if ($_getValidationField[i]) {
...
var getNameInput = document.getElementById('c-name');
if (getNameInput) {
  getNameInput.addEventListener('input', function () {
    var getNameInputValue = this.value;
...
var getEmailInput = document.getElementById('c-email');
if (getEmailInput) {
  getEmailInput.addEventListener('input', function () {
    var getEmailInputValue = this.value;
...
var getPhoneInput = document.getElementById('c-phone');
if (getPhoneInput) {
  getPhoneInput.addEventListener('input', function () {
    var getPhoneInputValue = this.value;
