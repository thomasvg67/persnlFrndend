                    ...
                    <div id="ct" className="note-container note-grid">
                      {getFilteredNotes().length === 0 ? (
                        ...
                        getFilteredNotes().map(note => (
                          <TimelineCard key={note._id} note={note} onDelete={handleRemoveNote} onToggleFav={handleFavToggle} onTagChange={handleTagChange} onEdit={handleEditNote} setLoading={(loader) => setLoading(prev => ({ ...prev, action: loader }))} />
                        ))
                      )}
                    </div>
                  </div>
