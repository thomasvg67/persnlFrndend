...
const ContactTest1 = () => {
    ...
    useEffect(() => {
        ...
        script.src = '/assets/js/apps/invoice-list.js';
        script.async = true;
                                                ...
                                                <tr key={contact._id}>
                                                    ...
                                                    <td>
                                                        <div className="d-flex">
                                                            ...
                                                            <div>
                                                                <p className="align-self-center mb-0 user-name">{contact.name}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {contact.gmap ? (
                                                            ...
                                                            >
                                                                {contact.loc || 'View Location'}
                                                            </a>
                                                        ) : (
                                                            <span className="inv-loc">{contact.loc || '-'}</span>
                                                        )}
                                                    </td>
                                                    <td><span className="inv-phone">{contact.ph}</span></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span
                                                            ...
                                                            data-bs-html="true"
                                                            title={feedbacksMap[contact._id] ? stripHtml(feedbacksMap[contact._id]) : 'No feedback'}
                                                            style={{ cursor: feedbacksMap[contact._id] ? "pointer" : "default" }}
                                                            onClick={() => feedbacksMap[contact._id] && handleFeedbackClick(contact._id)}
                                                        >
                                                            {feedbacksMap[contact._id]
                                                                ? stripHtml(feedbacksMap[contact._id]).slice(0, 15) + (stripHtml(feedbacksMap[contact._id]).length > 15 ? '...' : '')
                                                                : '-'}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span className="inv-date">
                                                            ...
                                                            {contact.nxtAlrt ? new Date(contact.nxtAlrt).toLocaleDateString() : '-'}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div className="action-icons d-flex align-items-center">
                                                            <a 
                                                                className="action-edit mr-3" 
